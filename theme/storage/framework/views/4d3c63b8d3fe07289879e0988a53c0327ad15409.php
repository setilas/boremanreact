      ...
      <div id="sidebar-menu">
         <ul class="sidebar-links custom-scrollbar">
            ...
            <li class="sidebar-list">
               ...
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/project' ? 'active' : ''); ?>" href="#" ><i data-feather="box"></i><span><?php echo e(trans('lang.Project')); ?> </span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='file-manager' ? 'active' : ''); ?>" href="<?php echo e(route('file-manager')); ?>"><i data-feather="git-pull-request"> </i><span><?php echo e(trans('lang.File manager')); ?></span></a>
            </li>

            <li class="sidebar-list">
               <label class="badge badge-info"><?php echo e(trans('lang.Latest')); ?> </label>
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='kanban' ? 'active' : ''); ?>" href="<?php echo e(route('kanban')); ?>"><i data-feather="monitor"> </i><span><?php echo e(trans('lang.Kanban Board')); ?></span>
               </a>
            </li>
            
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/ecommerce' ? 'active' : ''); ?>" href="#">
                  <i data-feather="shopping-bag"></i><span><?php echo e(trans('lang.Ecommerce')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='bookmark' ? 'active' : ''); ?>" href="<?php echo e(route('bookmark')); ?>"><i data-feather="heart"> </i><span><?php echo e(trans('lang.Bookmarks')); ?></span></a>
            </li>

            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='contacts' ? 'active' : ''); ?>" href="<?php echo e(route('contacts')); ?>"><i data-feather="list"> </i><span><?php echo e(trans('lang.Contacts')); ?></span></a>
            </li>

            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='task' ? 'active' : ''); ?>" href="<?php echo e(route('task')); ?>"><i data-feather="check-square"> </i><span><?php echo e(trans('lang.Tasks')); ?></span></a>
            </li>

            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='task' ? 'active' : ''); ?>" href="<?php echo e(route('task')); ?>"><i data-feather="calendar"> </i><span><?php echo e(trans('lang.Calendar')); ?></span></a>
            </li>

            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='social-app' ? 'active' : ''); ?>" href="<?php echo e(route('social-app')); ?>"><i data-feather="zap"> </i><span><?php echo e(trans('lang.Social App')); ?></span></a>
            </li>

            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='to-do' ? 'active' : ''); ?>" href="<?php echo e(route('to-do')); ?>"><i data-feather="clock"> </i><span><?php echo e(trans('lang.To-Do')); ?></span></a>
            </li>

            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName() == 'search' ? 'active' : ''); ?>" href="<?php echo e(route('search')); ?>"><i data-feather="search"> </i><span><?php echo e(trans('lang.Search Result')); ?></span></a>
            </li>
            ...
            <li class="sidebar-list">
               ...
               <ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/forms' ? 'block;' : 'none;'); ?>">
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['form-validation', 'base-input', 'radio-checkbox-control', 'input-group', 'megaoptions']) ? 'active' : ''); ?>" href="#">
                        Form Controls
                  ...
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['datepicker', 'time-picker', 'datetimepicker','daterangepicker' ,'touchspin', 'select2', 'switch', 'typeahead', 'clipboard']) ? 'active' : ''); ?>" href="#">
                        Form Widgets
                  ...
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['default-form', 'form-wizard', 'form-wizard-two', 'form-wizard-three', 'form-wizard-four']) ? 'active' : ''); ?>" href="#">
                        Form layout
                        <div class="according-menu"><i class="fa fa-angle-<?php echo e(in_array(Route::currentRouteName(), ['default-form', 'form-wizard', 'form-wizard-two', 'form-wizard-three', 'form-wizard-four']) ? 'down' : 'right'); ?>"></i></div>
                     </a>
                     <ul class="nav-sub-childmenu submenu-content" style="display: <?php echo e(in_array(Route::currentRouteName(), ['default-form', 'form-wizard', 'form-wizard-two', 'form-wizard-three', 'form-wizard-four']) ? 'block' : 'none;'); ?>;">
                           ...
                           <li><a href="<?php echo e(route('form-wizard-four')); ?>" class="<?php echo e(Route::currentRouteName()=='form-wizard-four' ? 'active' : ''); ?>">Form Wizard 4</a></li>
                     </ul>
                  </li>
               </ul>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/tables' ? 'active' : ''); ?>" href="#">
                  <i data-feather="server"></i><span><?php echo e(trans('lang.Tables')); ?></span>
               ...
               <ul class="sidebar-submenu"  style="display: <?php echo e(request()->route()->getPrefix() == '/tables' ? 'block;' : 'none;'); ?>">
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['bootstrap-basic-table', 'bootstrap-sizing-table', 'bootstrap-sizing-table', 'bootstrap-border-table', 'bootstrap-styling-table', 'table-components']) ? 'active' : ''); ?>" href="#">
                        Bootstrap Tables
                  ...
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['datatable-basic-init', 'datatable-advance', 'datatable-styling', 'datatable-ajax', 'datatable-server-side', 'datatable-plugin', 'datatable-api']) ? 'active' : ''); ?>" href="#">
                        Data Tables
                  ...
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['datatable-ext-autofill', 'datatable-ext-basic-button', 'datatable-ext-col-reorder', 'datatable-ext-fixed-header', 'datatable-ext-html-5-data-export', 'datatable-ext-responsive', 'datatable-ext-row-reorder', 'datatable-ext-scroller']) ? 'active' : ''); ?>" href="#">
                        Ex. Data Tables
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/ui-kits' ? 'active' : ''); ?>" href="#">
                  <i data-feather="box"></i><span><?php echo e(trans('lang.Ui Kits')); ?></span>
               ...
               <ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/ui-kits' ? 'block;' : 'none;'); ?>">
                  ...
                  <li>
                     <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['tab-bootstrap','tab-material']) ? 'active' : ''); ?>" href="#">
                        Tabs
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/bonus-ui' ? 'active' : ''); ?>" href="#">
                  <i data-feather="folder-plus"></i><span><?php echo e(trans('lang.Bonus Ui')); ?></span>
                  <div class="according-menu"><i class="fa fa-angle-<?php echo e(request()->route()->getPrefix() == '/ui-kits' ? 'down' : 'right'); ?>"></i></div>
               </a>
               <ul class="sidebar-submenu" style="display: <?php echo e(request()->route()->getPrefix() == '/bonus-ui' ? 'block;' : 'none;'); ?>">
                     ...
                     <li><a href="<?php echo e(route('steps')); ?>" class="<?php echo e(Route::currentRouteName()=='steps' ? 'active' : ''); ?>">Steps</a></li>
                     ...
                     <li>
                        <a class="submenu-title <?php echo e(in_array(Route::currentRouteName(), ['timeline-v-1','timeline-v-2', 'timeline-small']) ? 'active' : ''); ?>" href="#">
                           Timeline
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/builders' ? 'active' : ''); ?>" href="#">
                  <i data-feather="edit-3"></i><span><?php echo e(trans('lang.Builders')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/animation' ? 'active' : ''); ?>" href="#">
                  <i data-feather="cloud-drizzle"></i><span><?php echo e(trans('lang.Animation')); ?></span>
               </a>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/icons' ? 'active' : ''); ?>" href="#">
                  <i data-feather="command"></i><span><?php echo e(trans('lang.Icons')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/buttons' ? 'active' : ''); ?>" href="#">
                  <i data-feather="cloud"></i><span><?php echo e(trans('lang.Buttons')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='sample-page' ? 'active' : ''); ?>" href="<?php echo e(route('sample-page')); ?>"><i data-feather="file-text"> </i><span><?php echo e(trans('lang.Sample page')); ?></span></a>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='internationalization' ? 'active' : ''); ?>" href="<?php echo e(route('internationalization')); ?>" href="internationalization.html"><i data-feather="globe"> </i><span><?php echo e(trans('lang.Internationalization')); ?></span></a>
            </li>
            
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='layout-light' ? 'active' : ''); ?>" href="<?php echo e(route('layout-light')); ?>"><i data-feather="anchor"> </i><span><?php echo e(trans('lang.Starter kit')); ?></span></a>
            </li>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/gallery' ? 'active' : ''); ?>" href="#">
                  <i data-feather="image"></i><span><?php echo e(trans('lang.Gallery')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/blog' ? 'active' : ''); ?>" href="#">
                  <i data-feather="film"></i><span><?php echo e(trans('lang.Blog')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='faq' ? 'active' : ''); ?>" href="<?php echo e(route('faq')); ?>"><i data-feather="help-circle"> </i><span><?php echo e(trans('lang.FAQ')); ?></span></a>
            </li>
            
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/job-search' ? 'active' : ''); ?>" href="#">
                  <i data-feather="package"></i><span><?php echo e(trans('lang.Job Search')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/learning' ? 'active' : ''); ?>" href="#">
                  <i data-feather="radio"></i><span><?php echo e(trans('lang.Learning')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/maps' ? 'active' : ''); ?>" href="#">
                  <i data-feather="map"></i><span><?php echo e(trans('lang.Maps')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(request()->route()->getPrefix() == '/editors' ? 'active' : ''); ?>" href="#">
                  <i data-feather="edit"></i><span><?php echo e(trans('lang.Editors')); ?></span>
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName() == 'knowledgebase' ? 'active' : ''); ?>" href="<?php echo e(route('knowledgebase')); ?>">
                  <i data-feather="sunrise"> </i><span><?php echo e(trans('lang.Knowledgebase')); ?></span>
               </a>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='support-ticket' ? 'active' : ''); ?>" href="<?php echo e(route('support-ticket')); ?>">
                  <i data-feather="users"> </i><span><?php echo e(trans('lang.Support Ticket')); ?></span>
               </a>
            </li>
         </ul>
      </div>
...
<?php /**PATH /home/ekta/Documents/GitHub/Cuba/resources/views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>