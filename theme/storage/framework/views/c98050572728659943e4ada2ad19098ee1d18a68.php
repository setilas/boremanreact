  ...
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper">
      <div class="logo-wrapper">
        <a href="<?php echo e(route('/')); ?>"><img class="img-fluid" src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="" /></a>
      </div>
              ...
              <div class="row">
                ...
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul>
                      <li class="pl-0"><a href="<?php echo e(route('basic-template')); ?>">Basic Email</a></li>
                      <li class="pl-0"><a href="<?php echo e(route('email-header')); ?>">Basic With Header</a></li>
                      <li class="pl-0"><a href="<?php echo e(route('template-email')); ?>">Ecomerce Template</a></li>
                      <li class="pl-0"><a href="<?php echo e(route('template-email-2')); ?>">Email Template 2</a></li>
                      <li class="pl-0"><a href="<?php echo e(route('ecommerce-templates')); ?>">Ecommerce Email</a></li>
                      <li class="pl-0"><a href="<?php echo e(route('email-order-success')); ?>">Order Success</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
          ...
          <ul class="header-level-menu menu-to-be-close">
            ...
            <li>
              ...
              <ul class="header-level-sub-menu">
                <li>
                  <a href="<?php echo e(route('file-manager')); ?>" data-original-title="" title=""> <i data-feather="user"></i><span>User Profile</span></a>
                </li>
                <li>
                  <a href="<?php echo e(route('file-manager')); ?>" data-original-title="" title=""> <i data-feather="user-minus"></i><span>User Edit</span></a>
                </li>
                <li>
                  <a href="<?php echo e(route('file-manager')); ?>" data-original-title="" title=""> <i data-feather="user-check"></i><span>Users Cards</span></a>
                </li>
              </ul>
            </li>
            <li>
      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <ul class="cart-dropdown onhover-show-div">
            ...
            <li class="mt-0">
              <div class="media">
                <img class="img-fluid rounded-circle mr-3 img-60" src="<?php echo e(asset('assets/images/ecommerce/01.jpg')); ?>" alt="" />
            ...
            <li class="mt-0">
              <div class="media">
                <img class="img-fluid rounded-circle mr-3 img-60" src="<?php echo e(asset('assets/images/ecommerce/03.jpg')); ?>" alt="" />
                <div class="media-body">
                  <span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                  <p>Yellow(#fcb102)</p>
                  <div class="qty-box">
            ...
            <li><a class="btn btn-block btn-primary view-cart" href="<?php echo e(route('cart')); ?>">Go to shoping bag</a><a class="btn btn-block btn-secondary view-cart" href="<?php echo e(route('checkout')); ?>">Checkout</a></li>
          </ul>
        </li>
        <li class="onhover-dropdown">
          ...
          <ul class="chat-dropdown onhover-show-div">
            ...
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle mr-3" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />
            ...
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle mr-3" src="<?php echo e(asset('assets/images/user/2.jpg')); ?>" alt="" />
                <div class="status-circle online"></div>
                <div class="media-body">
            ...
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle mr-3" src="<?php echo e(asset('assets/images/user/4.jpg')); ?>" alt="" />
...
</div><?php /**PATH /home/ekta/Documents/GitHub/Cuba/resources/views/layouts/simple/header.blade.php ENDPATH**/ ?>