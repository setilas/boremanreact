								...
								<table class="table table-bordered">
									<tbody>
										...
										<tr>
											...
											<td>
												<button class="btn btn-primary"><i class="fa fa-spin fa-spinner mr-2"></i>Expand UP</button>
											</td>
								...
								<table class="table table-bordered">
									<tbody>
										<tr>
											...
											<td><span>Use data-toggle="tooltip" for hover trigger. This is a default trigger</span></td>
										</tr>
										<tr>
											<td>Link</td>
											<td class="w-50"><a class="btn btn-primary" href="#" data-toggle="tooltip" title="" role="button" data-original-title="Hooray!">Link</a></td>
