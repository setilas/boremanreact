            ...
            <div class="chart-widget-top">
               <div class="row card-body">
                  <div class="col-5">
                     ...
                     <span class="num"><span class="counter">90</span>%<i class="icon-angle-up f-12 ml-1"></i></span>
                  </div>
            ...
            <div class="chart-widget-top">
               <div class="row card-body">
                  <div class="col-7">
                     ...
                     <span class="num"><span class="counter">30</span>%<i class="icon-angle-up f-12 ml-1"></i></span>
                  </div>
            ...
            <div class="chart-widget-top">
               <div class="row card-body">
                  <div class="col-8">
                     ...
                     <span class="num"><span class="counter">68</span>%<i class="icon-angle-up f-12 ml-1"></i></span>
                  </div>
               ...
               <div class="bottom-content card-body">
                  ...
                  <div class="row text-center">
                     <div class="col-4 b-r-light">
                        <div>
                           <span class="font-primary">12%<i class="icon-angle-up f-12 ml-1"></i></span><span class="text-muted block-bottom">Year</span>
                           <h4 class="num m-0"><span class="counter color-bottom">3659</span>M</h4>
                        </div>
                     </div>
                     <div class="col-4 b-r-light">
                        <div>
                           <span class="font-primary">15%<i class="icon-angle-up f-12 ml-1"></i></span><span class="text-muted block-bottom">Month</span>
                           <h4 class="num m-0"><span class="counter color-bottom">698</span>M</h4>
                        </div>
                     </div>
                     <div class="col-4">
                        <div>
                           <span class="font-primary">34%<i class="icon-angle-up f-12 ml-1"></i></span><span class="text-muted block-bottom">Today</span>
