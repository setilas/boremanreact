				...
				<div class="card">
					<div class="profile-img-style">
						...
						<div class="img-container">
							<div id="aniimated-thumbnials"><a href="{{asset('assets/images/other-images/profile-style-img3.png')}}"><img class="img-fluid rounded" src="{{asset('assets/images/other-images/profile-style-img3.png')}}" alt="gallery"></a></div>
						</div>
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="profile-img-style">
						...
						<hr>
						<p>you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.</p>
						<div class="row mt-4 pictures" id="aniimated-thumbnials-2"><a class="col-sm-6" href="{{asset('assets/images/other-images/profile-style-img3.png')}}"><img class="img-fluid rounded" src="{{asset('assets/images/other-images/profile-style-img.png')}}" alt="gallery"></a><a class="col-sm-6" href="{{asset('assets/images/other-images/profile-style-img3.png')}}"><img class="img-fluid rounded" src="{{asset('assets/images/other-images/profile-style-img.png')}}" alt="gallery"></a></div>
						<div class="like-comment mt-4">
							<ul class="list-inline">
								<li class="list-inline-item border-right pr-3">
									<label class="m-0"><a href="#"><i class="fa fa-heart"></i></a>  Like</label><span class="ml-2 counter">2659</span>
					...
					<div class="profile-img-style">
						...
						<div class="row">
							<div class="col-lg-12 col-xl-4">
								<div id="aniimated-thumbnials-3"><a href="{{asset('assets/images/blog/img.png')}}"><img class="img-fluid rounded" src="{{asset('assets/images/blog/img.png')}}" alt="gallery"></a></div>
