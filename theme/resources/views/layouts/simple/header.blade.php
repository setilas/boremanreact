              ...
              <div class="row">
                ...
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul>
                      <li class="pl-0"><a href="{{route('basic-template')}}">Basic Email</a></li>
                      <li class="pl-0"><a href="{{route('email-header')}}">Basic With Header</a></li>
                      <li class="pl-0"><a href="{{route('template-email')}}">Ecomerce Template</a></li>
                      <li class="pl-0"><a href="{{route('template-email-2')}}">Email Template 2</a></li>
                      <li class="pl-0"><a href="{{route('ecommerce-templates')}}">Ecommerce Email</a></li>
                      <li class="pl-0"><a href="{{route('email-order-success')}}">Order Success</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
          ...
          <ul class="header-level-menu menu-to-be-close">
            ...
            <li>
              ...
              <ul class="header-level-sub-menu">
                <li>
                  <a href="{{ route('file-manager') }}" data-original-title="" title=""> <i data-feather="user"></i><span>User Profile</span></a>
                </li>
                <li>
                  <a href="{{ route('file-manager') }}" data-original-title="" title=""> <i data-feather="user-minus"></i><span>User Edit</span></a>
                </li>
                <li>
                  <a href="{{ route('file-manager') }}" data-original-title="" title=""> <i data-feather="user-check"></i><span>Users Cards</span></a>
                </li>
              </ul>
            </li>
            <li>
      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <ul class="cart-dropdown onhover-show-div">
            ...
            <li><a class="btn btn-block btn-primary view-cart" href="{{ route('cart') }}">Go to shoping bag</a><a class="btn btn-block btn-secondary view-cart" href="{{ route('checkout') }}">Checkout</a></li>
          </ul>
        </li>
        <li class="onhover-dropdown">
