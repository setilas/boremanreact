                  ...
                  <div class="card-body">
                     <div class="email-app-sidebar left-bookmark">
                        ...
                        <ul class="nav main-menu contact-options" role="tablist">
                           <li class="nav-item">
                              <button class="badge-light-primary btn-block btn-mail" type="button" data-toggle="modal" data-target="#exampleModal"><i class="mr-2" data-feather="users"></i> New Contacts</button>
                           ...
                           <li><a id="pills-personal-tab" data-toggle="pill" href="#pills-personal" role="tab" aria-controls="pills-personal" aria-selected="true"><span class="title"> Personal</span></a></li>
                           <li>
                              <button class="btn btn-category" type="button" data-toggle="modal" data-target="#exampleModal1"><span class="title"> + Add Category</span></button>
                           ...
                           <li><a class="show" id="pills-organization-tab" data-toggle="pill" href="#pills-organization" role="tab" aria-controls="pills-organization" aria-selected="false"><span class="title"> Organization</span></a></li>
                     ...
                     <div class="tab-content">
                                 ...
                                 <div class="row list-persons" id="addcon">
                                    <div class="col-xl-4 xl-50 col-md-5">
                                       <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                          <a class="contact-tab-0 nav-link active" id="v-pills-user-tab" data-toggle="pill" onclick="activeDiv(0)" href="#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-1 nav-link" id="v-pills-profile-tab" data-toggle="pill" onclick="activeDiv(1)" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-2 nav-link" id="v-pills-messages-tab" data-toggle="pill" onclick="activeDiv(2)" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-3 nav-link" id="v-pills-settings-tab" data-toggle="pill" onclick="activeDiv(3)" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-4 nav-link" id="v-pills-contact1-tab" data-toggle="pill" onclick="activeDiv(4)" href="#v-pills-contact1" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-5 nav-link" id="v-pills-contact8-tab" data-toggle="pill" onclick="activeDiv(5)" href="#v-pills-contact1" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-6 nav-link" id="v-pills-contact3-tab" data-toggle="pill" onclick="activeDiv(6)" href="#v-pills-contact1" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                             <div class="media">
                                    ...
                                    <div class="col-xl-8 xl-50 col-md-7">
                                             ...
                                             <div class="profile-mail">
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(0)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_0">18</span><span class="birth_month_0 ml-1">May</span><span class="birth_year_0 ml-1">1994</span></span></li>
                                                ...
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(1)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_1">7</span><span class="birth_month_1 ml-1">Feb</span><span class="birth_year_1 ml-1">1995</span></span></li>
                                                ...
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(2)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Gender <span class="font-primary">Male</span></li>
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_2">20</span><span class="birth_month_2 ml-1">Jul</span><span class="birth_year_2 ml-1">1993</span></span></li>
                                                ...
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(3)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Gender <span class="font-primary">Male</span></li>
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_3">25</span><span class="birth_month_3 ml-1">Aug</span><span class="birth_year_3 ml-1">1996</span></span></li>
                                                ...
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(4)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Gender <span class="font-primary">Male</span></li>
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_4">30</span><span class="birth_month_4 ml-1">Oct</span><span class="birth_year_4 ml-1">1992</span></span></li>
                                                ...
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(5)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Gender <span class="font-primary">Male</span></li>
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_5">12</span><span class="birth_month_5 ml-1">Nov</span><span class="birth_year_5 ml-1">1994</span></span></li>
                                                ...
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         ...
                                                         <li><a href="#" onclick="printContact(6)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                                   ...
                                                   <ul>
                                                      ...
                                                      <li>Gender <span class="font-primary">Male</span></li>
                                                      <li>Birthday<span class="font-primary"> <span class="birth_day_6">8</span><span class="birth_month_6 ml-1">Dec</span><span class="birth_year_6 ml-1">1992</span></span></li>
                                       ...
                                       <div class="contact-editform pl-0">
                                          <form>
                                             <div class="form-row">
                                                <div class="form-group mb-3 col-md-12">
                                                   <label>Name</label>
                                             ...
                                             <div class="form-row more-data">
                                                ...
                                                <div class="form-group mb-3 col-md-12 mb-0">
                                             ...
                                             <a class="pl-0 edit-information" href="#">Edit more information</a>
                                 ...
                                 <div class="row list-persons">
                                    <div class="col-xl-4 xl-50 col-md-5">
                                       <div class="nav flex-column nav-pills" id="v-pills-tab1" role="tablist" aria-orientation="vertical">
                                          <a class="nav-link active" id="v-pills-iduser-tab" data-toggle="pill" href="#v-pills-iduser" role="tab" aria-controls="v-pills-iduser" aria-selected="true">
                                             <div class="media">
                                          ...
                                          <a class="nav-link" id="v-pills-iduser1-tab" data-toggle="pill" href="#v-pills-iduser1" role="tab" aria-controls="v-pills-iduser1" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="nav-link" id="v-pills-iduser2-tab" data-toggle="pill" href="#v-pills-iduser2" role="tab" aria-controls="v-pills-iduser2" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="nav-link" id="v-pills-iduser3-tab" data-toggle="pill" href="#v-pills-iduser3" role="tab" aria-controls="v-pills-iduser3" aria-selected="false">
                                             <div class="media">
                                             ...
                                             <div class="profile-mail">
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         <li><a href="#" onclick="printContact(7)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                                             ...
                                             <div class="profile-mail">
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         <li><a href="#" onclick="printContact(8)" data-toggle="modal" data-target="#printModal">Print</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
                        ...
                        <div id="right-history">
                           ...
                           <div class="history-details">
                              ...
                              <div class="media">
                                 <i class="icofont icofont-star mr-3"></i>
                                 <div class="media-body mt-0">
