									...
									<ul>
										<li>
											<div class="message my-message">
												<img class="rounded-circle float-left chat-user-img img-30" src="{{asset('assets/images/user/3.png')}}" alt="">
										...
										<li class="clearfix">
											<div class="message other-message pull-right">
												<img class="rounded-circle float-right chat-user-img img-30" src="{{asset('assets/images/user/12.png')}}" alt="">
