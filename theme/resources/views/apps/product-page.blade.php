         ...
         <div class="col-xl-5 xl-100">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="product-price f-28">$26.00  
                     <del>$350.00 </del>
                  </div>
                  ...
                  <hr>
                  <div class="m-t-15">
                     <button class="btn btn-primary m-r-10" type="button" title=""> <i class="fa fa-shopping-basket mr-1"></i>Add To Cart</button>
                     <button class="btn btn-success m-r-10" type="button" title=""> <i class="fa fa-shopping-cart mr-1"></i>Buy Now</button><a class="btn btn-secondary" href="#"> <i class="fa fa-heart mr-1"></i>Add To WishList</a>
                  </div>
               </div>
            </div>
         </div>
