   ...
   <div class="row">
      ...
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body btn-showcase">
               <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalfat" data-whatever="@mdo">Open modal for @mdo</button>
               <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalmdo" data-whatever="@fat">Open modal for @fat</button>
               <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap">Open modal for @getbootstrap</button>
