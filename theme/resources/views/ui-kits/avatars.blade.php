            ...
            <div class="card">
               ...
               <div class="card-body avatar-showcase">
                  <div class="avatars">
                     ...
                     <div class="avatar">
                        <img class="img-90 rounded-circle" src="{{asset('assets/images/user/1.jpg')}}" alt="#">
                        <div class="status status-90"></div>
                     </div>
                     <div class="avatar">
                        <img class="img-80 rounded-circle" src="{{asset('assets/images/user/1.jpg')}}" alt="#">
                        <div class="status status-80 bg-success"></div>
                     </div>
                     <div class="avatar">
                        <img class="img-70 rounded-circle" src="{{asset('assets/images/user/1.jpg')}}" alt="#">
                     ...
                     <div class="avatar">
                        <img class="img-30 rounded-circle" src="{{asset('assets/images/user/1.jpg')}}" alt="#">
