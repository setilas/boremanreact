							...
							<div class="col-sm-6">
								<div class="card">
									<div class="media p-20">
										...
										<div class="media-body">
											<h6 class="mt-0 mega-title-badge">COD<span class="badge badge-primary pull-right digits">50 INR</span></h6>
											<p>Estimated 10 to 15 Day Shiping (Duties end tax may be due delivery)</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-9">
								<div class="card">
									<div class="media p-20">
										...
										<div class="media-body">
											<h6 class="mt-0 mega-title-badge">COD<span class="badge badge-primary pull-right digits">50 INR</span></h6>
											<p>Estimate 5 Day Shiping ( Duties end tax may be due delivery )</p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-9 offset-sm-3">
								<div class="card">
									<div class="media p-20">
										...
										<div class="media-body">
											<h6 class="mt-0 mega-title-badge">Fast <span class="badge badge-secondary pull-right digits">100 INR</span></h6>
											<p>Estimate 1 Day Shiping ( Duties end tax may be due delivery )</p>
										</div>
									</div>
								</div>
							</div>
