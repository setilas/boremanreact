...
Route::prefix('page-layouts')->group(function () {
    Route::view('layout-light', 'dashboard.index')->name('pages-layout-light');
    Route::view('layout-rtl', 'dashboard.index')->name('pages-layout-rtl');
    Route::view('layout-dark', 'dashboard.index')->name('pages-layout-dark');
    Route::view('dark-rtl-layout', 'dashboard.index')->name('pages-dark-rtl-layout');
    Route::view('semi-dark', 'dashboard.index')->name('pages-semi-dark');
    Route::view('semi-dark-rtl', 'dashboard.index')->name('pages-semi-dark-rtl');
    Route::view('compact-layout', 'dashboard.index')->name('pages-compact-layout');
    Route::view('compact-rtl-layout', 'dashboard.index')->name('pages-compact-rtl-layout');
    Route::view('layout-box', 'dashboard.index')->name('pages-layout-box');
    Route::view('vertical-layout', 'dashboard.index')->name('pages-vertical-layout');
    Route::view('vertical-rtl-layout', 'dashboard.index')->name('pages-vertical-rtl-layout');
    Route::view('dark-box-layout', 'dashboard.index')->name('pages-dark-box-layout');
    Route::view('vertical-box-layout', 'dashboard.index')->name('pages-vertical-box-layout');
    Route::view('compact-dark-layout', 'dashboard.index')->name('pages-compact-dark-layout');
    Route::view('compact-dark-rtl-layout', 'dashboard.index')->name('pages-compact-dark-rtl-layout');
}); 

Route::prefix('page-layout')->group(function () {
    Route::view('layout-light', 'back.page-layout.layout-light')->name('layout-light');
    Route::view('layout-dark', 'back.page-layout.layout-dark')->name('layout-dark');
